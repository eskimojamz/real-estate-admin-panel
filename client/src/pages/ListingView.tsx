...
function ListingView(){
    ...
    Geocode.setApiKey("AIzaSyAmusgAHh0lspEG17y6FAetvAxtmqt1AzI");
        ...
        <div className="listing-view-wrapper">
            <div className="listing-view-header">
                <div className="listing-view-back">
                    <button className="listing-view-back-btn">
                        ← Back
                    </button>
                </div>
            ...
            <div className="listing-view">
                ...
                <div className="listing-view-text">
                    ...
                    <div className="listing-view-map">
                        <GoogleMap
                            bootstrapURLKeys={{ key: 'AIzaSyAmusgAHh0lspEG17y6FAetvAxtmqt1AzI' }}
